    ...
    <div v-if="isOpen">
        ...
        <div class="modal-content">
            ...
            <div class="modal-bottom">
                <div v-if="!useCustom">
                    <span class="mr-3 block w-full text-sm font-bold text-secondary-500">Network</span>
                    <div class="flex items-center">
                        <div class="inline-block relative w-full sm:w-4/5 mr-3">
                            ...
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-secondary-700"
                            >
                                <svg
