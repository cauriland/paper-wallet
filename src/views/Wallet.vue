                ...
                <div class="flex flex-col sm:flex-row items-center wallet-property-row pb-6">
                    ...
                    <div class="flex flex-col ml-3">
                        <div class="flex">
                            ...
                            <button
                                id="address-copy"
                                class="print-ignore text-secondary-500 ml-3"
                ...
                <div class="flex flex-col sm:flex-row items-center pt-6">
                    ...
                    <div class="flex flex-col ml-3 w-full">
                        ...
                        <div class="passphrase-grid mt-2">
                            ...
                            >
                                <span>{{ word }}</span>
                                <span class="passphrase-index text-secondary-500">{{ index + 1 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
export default class Wallet extends Vue {
    ...
    public save() {
        ...
        html2canvas(document.querySelector("#wallet-details"), {
            ...
            link.download = `cauri-paper-wallet-${this.wallet.address}.jpg`;
            link.click();
